...
// ==============================================================
#ifndef __DLU_temp_H__
#define __DLU_temp_H__
...
struct DLU_temp_ram : public sc_core::sc_module {
...
DLU_temp_ram* meminst;


SC_CTOR(DLU_temp) {
meminst = new DLU_temp_ram("DLU_temp_ram");
