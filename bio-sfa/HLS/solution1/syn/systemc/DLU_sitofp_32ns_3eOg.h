...
// ==============================================================
#ifndef __DLU_sitofp_32ns_3eOg__HH__
#define __DLU_sitofp_32ns_3eOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DLU_sitofp_32ns_3eOg) {
    ...
    SC_CTOR(DLU_sitofp_32ns_3eOg):  ACMP_sitofp_U ("ACMP_sitofp_U") {
