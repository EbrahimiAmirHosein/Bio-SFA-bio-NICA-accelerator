...
architecture rtl of solve_qp_C_rom is 
...
architecture arch of solve_qp_C is
    component solve_qp_C_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    solve_qp_C_rom_U :  component solve_qp_C_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
