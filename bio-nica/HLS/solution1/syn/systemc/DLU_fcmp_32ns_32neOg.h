...
// ==============================================================
#ifndef __DLU_fcmp_32ns_32neOg__HH__
#define __DLU_fcmp_32ns_32neOg__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DLU_fcmp_32ns_32neOg) {
    ...
    SC_CTOR(DLU_fcmp_32ns_32neOg):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
