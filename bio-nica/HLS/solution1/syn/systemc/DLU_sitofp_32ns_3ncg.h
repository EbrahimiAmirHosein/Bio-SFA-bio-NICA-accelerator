...
// ==============================================================
#ifndef __DLU_sitofp_32ns_3ncg__HH__
#define __DLU_sitofp_32ns_3ncg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DLU_sitofp_32ns_3ncg) {
    ...
    SC_CTOR(DLU_sitofp_32ns_3ncg):  ACMP_sitofp_U ("ACMP_sitofp_U") {
