...
// ==============================================================
#ifndef __DLU_fpext_32ns_64ibs__HH__
#define __DLU_fpext_32ns_64ibs__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(DLU_fpext_32ns_64ibs) {
    ...
    SC_CTOR(DLU_fpext_32ns_64ibs):  ACMP_fpext_U ("ACMP_fpext_U") {
