...
// ==============================================================
#ifndef __DLU_dcmp_64ns_64nmb6__HH__
#define __DLU_dcmp_64ns_64nmb6__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DLU_dcmp_64ns_64nmb6) {
    ...
    SC_CTOR(DLU_dcmp_64ns_64nmb6):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
